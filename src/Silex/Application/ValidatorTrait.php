...
trait ValidatorTrait
{
    ...
    {
        return $this['validator']->validate($object, $groups = null);
    }
    ...
    {
        return $this['validator']->validatePropertyValue($class, $property, $value, $groups = null);
    }
    ...
    {
        return $this['validator']->validateValue($value, $constraint, $groups = null);
    }
}
